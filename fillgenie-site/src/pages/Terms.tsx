      ...
      <Section background="warm-sand" className="py-12 sm:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-text-muted">
            Please read these Terms of Service carefully before using FillGenie. By accessing or using our service, 
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card>
            ...
            <p className="text-text-muted">
              By creating an account or using FillGenie, you agree to these Terms of Service and our Privacy Policy. 
          ...
          <Card>
            ...
            <p className="text-text-muted mb-3">
              FillGenie is a browser extension and web service that uses AI to automatically fill online forms using 
          ...
          <Card>
            ...
            <div className="space-y-3 text-text-muted">
              <p><strong className="text-text-main">Age Requirement:</strong> You must be at least 18 years old to use FillGenie.</p>
          ...
          <Card>
            ...
            <div className="space-y-3 text-text-muted">
              ...
              <p><strong className="text-text-main">License to Use:</strong> By uploading content, you grant us a limited license to store, process, and use your documents solely for the purpose of providing the FillGenie service to you.</p>
          ...
          <Card>
            ...
            <div className="space-y-3 text-text-muted">
              <p><strong className="text-text-main">Free Plan:</strong> FillGenie offers a free plan with limited features. No payment information is required for the free plan.</p>
              ...
              <p><strong className="text-text-main">Refunds:</strong> We offer a 14-day money-back guarantee for Premium plans. Contact us at fillgenie@gmail.com to request a refund.</p>
            </div>
          </Card>
          ...
          <Card>
            ...
            <div className="space-y-3 text-text-muted">
              <p><strong className="text-text-main">No Warranty:</strong> FillGenie is provided "as is" without warranties of any kind. We do not guarantee that the service will be error-free, secure, or continuously available.</p>
              ...
              <p><strong className="text-text-main">Third-Party Sites:</strong> We are not responsible for the content, policies, or practices of third-party websites where you use FillGenie.</p>
              <p><strong className="text-text-main">Limitation of Liability:</strong> To the maximum extent permitted by law, FillGenie and its team shall not be liable for any indirect, incidental, consequential, or punitive damages arising from your use of the service.</p>
            </div>
          </Card>
          ...
          <Card>
            ...
            <p className="text-text-muted">
              You agree to indemnify and hold FillGenie harmless from any claims, losses, liabilities, and expenses 
          ...
          <Card>
            ...
            <div className="space-y-3 text-text-muted">
              <p><strong className="text-text-main">Governing Law:</strong> These terms are governed by the laws of the United States and the state where FillGenie is registered, without regard to conflict of law principles.</p>
          ...
          <Card>
            ...
            <div className="space-y-3 text-text-muted">
              <p><strong className="text-text-main">Entire Agreement:</strong> These terms, together with our Privacy Policy, constitute the entire agreement between you and FillGenie.</p>
